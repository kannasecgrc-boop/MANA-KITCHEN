          ...
          <div className="p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-6 bg-green-50 rounded-3xl border border-green-100">
                 <p className="text-[10px] font-black text-green-600 uppercase tracking-widest mb-2">Total Revenue</p>
                 <p className="text-4xl font-black text-gray-900 tracking-tighter">₹{totalRevenue.toLocaleString()}</p>
              </div>
              <div className="p-6 bg-blue-50 rounded-3xl border border-blue-100">
                 <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mb-2">Est. Profit (35%)</p>
                 <p className="text-4xl font-black text-gray-900 tracking-tighter">₹{totalProfit.toLocaleString()}</p>
              </div>
              <div className="p-6 bg-purple-50 rounded-3xl border border-purple-100">
                 <p className="text-[10px] font-black text-purple-600 uppercase tracking-widest mb-2">Orders Completed</p>
              ...
              <div className="p-6 bg-orange-50 rounded-3xl border border-orange-100">
                 <p className="text-[10px] font-black text-orange-600 uppercase tracking-widest mb-2">Active Customers</p>
        ...
        {activeTab === 'inventory' && (
          <div className="p-10">
            <div className="flex justify-between items-center mb-8">
               <h3 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Menu Inventory</h3>
            ...
            {isProductModalOpen && (
              <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                ...
                <div className="relative bg-white rounded-[40px] p-8 w-full max-w-lg shadow-2xl animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
                   <h3 className="text-2xl font-black text-gray-900 uppercase tracking-tight mb-6">{editingProductId ? 'Edit Item Details' : 'Add New Item'}</h3>
                   <form onSubmit={handleProductSubmit} className="space-y-6">
                      <div>
                        <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Dish Name</label>
                        <input required value={productForm.name} onChange={e => setProductForm({...productForm, name: e.target.value})} className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 ring-brand outline-none font-bold" placeholder="e.g. Special Chicken Biryani" />
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                         <div>
                            ...
                            <input type="number" value={productForm.mrp} onChange={e => handleMrpChange(e.target.value)} className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 ring-brand outline-none font-bold" placeholder="300" />
                         </div>
                         <div>
                            <label className="block text-[10px] font-bold text-brand uppercase tracking-widest mb-1.5 ml-1">Discount (%)</label>
                            <input type="number" value={productForm.discount} onChange={e => handleDiscountChange(e.target.value)} className="w-full px-5 py-3 bg-gray-50 border-2 border-brand/20 rounded-2xl focus:ring-4 ring-brand outline-none font-bold text-brand" placeholder="10" />
                         </div>
                         <div>
                            <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Selling Price (₹)</label>
                            <input required type="number" value={productForm.price} onChange={e => handlePriceChange(e.target.value)} className="w-full px-5 py-3 bg-gray-900 text-white border border-gray-900 rounded-2xl focus:ring-4 ring-gray-200 outline-none font-bold" placeholder="270" />
                         </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                         <div>
                            ...
                            <select value={productForm.category} onChange={e => setProductForm({...productForm, category: e.target.value})} className="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 ring-brand outline-none font-bold appearance-none">
                              {['Biryanis', 'Starters', 'Curries', 'Breads', 'Desserts', 'Beverages'].map(c => (
            ...
            <div className="overflow-x-auto rounded-[32px] border border-gray-100">
              <table className="w-full text-left">
                <thead className="bg-gray-50 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                  <tr>
                    <th className="px-10 py-6">Dish Name</th>
          ...
          <div className="p-12">
             ...
             <form className="space-y-12" onSubmit={handleSaveSettings}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Application Name (Top Bar)</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Menu Section Title</label>
                       <input value={tempSettings.chefSectionTitle || "Chef's Recommendations"} onChange={e => setTempSettings({...tempSettings, chefSectionTitle: e.target.value})} className="w-full px-6 py-4 bg-gray-50 rounded-2xl border border-transparent focus:border-brand font-bold outline-none" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="col-span-1 md:col-span-2 border-b border-gray-100 pb-2 mb-2">
                        <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest">Operations & Contact</h4>
                    </div>
                    <div>
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Delivery Fee (₹)</label>
                    ...
                    <div>
                        <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">WhatsApp Number (Orders)</label>
                    ...
                    <div className="md:col-span-2">
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Company Address (Footer)</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="md:col-span-2">
                       ...
                       <input value={tempSettings.bannerHighlight} onChange={e => setTempSettings({...tempSettings, bannerHighlight: e.target.value})} className="w-full px-6 py-4 bg-gray-50 rounded-2xl border border-transparent focus:border-brand font-bold outline-none" placeholder="e.g. 50% OFF on Chicken 65" />
                    </div>
                    <div className="md:col-span-2">
                    ...
                    <div>
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Free Delivery Threshold (₹)</label>
                       ...
                       <p className="text-[9px] text-gray-400 mt-2 font-bold">Orders above this amount will have ₹0 delivery fee.</p>
                    </div>
                </div>
                    ...
                    <div className="md:col-span-2">
                       <div className="flex flex-col md:flex-row gap-4 mb-4">
                          <input 
                            ...
                            placeholder="Badge Text (e.g. 'AC Dining')" 
                          />
                          <input 
                            value={newBadgeLink} 
                            ...
                            placeholder="Link URL (e.g. https://maps.google.com)" 
                          />
                          <button 
                            type="button" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="col-span-1 md:col-span-2 border-b border-gray-100 pb-2 mb-2">
                        <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest">Operating Hours</h4>
                    </div>
                    <div>
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Lunch Timing</label>
                    ...
                    <div>
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Dinner Timing</label>
                    ...
                    <div className="md:col-span-2">
                       <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block">Operating Days (Tagline)</label>
