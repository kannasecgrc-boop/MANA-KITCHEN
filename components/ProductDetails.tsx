      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex gap-4">
            ...
            >
              {product.stock > 0 ? 'Add to Your Order' : 'Out of Stock'}
            </button>
          </div>

          <div className="mt-12 grid grid-cols-3 gap-4 border-t border-gray-100 pt-12">
             <div className="text-center">
                <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2">Prep Time</p>
                <p className="font-black text-gray-900">25-30 MINS</p>
             </div>
             <div className="text-center border-x border-gray-100">
                <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2">Spice Level</p>
                <p className="font-black text-brand uppercase">Medium Spicy</p>
             </div>
             <div className="text-center">
                <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2">Serves</p>
                <p className="font-black text-gray-900 uppercase">1-2 People</p>
             </div>
          </div>
        </div>
      </div>
