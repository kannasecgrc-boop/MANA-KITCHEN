      ...
      <div className="absolute inset-y-0 right-0 max-w-full flex">
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col rounded-l-[50px] overflow-hidden animate-in slide-in-from-right-full duration-500">
          <div className="flex items-center justify-between p-8 border-b border-gray-50 bg-white/80 sticky top-0 z-10">
            <div>
               <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tighter">Your Selection</h2>
               <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{items.length} items ready for prep</p>
            </div>
              ...
              {neededForFreeShip > 0 ? (
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                     <p className="text-xs font-bold text-gray-900">Add <span className="text-brand">₹{neededForFreeShip}</span> more for Free Delivery!</p>
                ...
                <div className="flex items-center gap-3">
                   ...
                   <p className="text-xs font-black text-green-600 uppercase tracking-wide">Free Delivery Unlocked!</p>
                </div>
              )}
            </div>
          )}
            ...
            {items.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 font-medium mt-2">The best Hyderabadi flavors are just a click away.</p>
                </div>
                <button 
                  onClick={onClose}
